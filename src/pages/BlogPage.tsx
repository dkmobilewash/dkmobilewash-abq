  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        >
          {/* Mobile hero image (hidden md+) */}
          <div
            className="absolute inset-0 md:hidden"
            style={{
              backgroundImage: "url('https://tfbmmnwyoraaealnfsfw.supabase.co/storage/v1/object/public/Website%20Pictures/Hero%20Image/best-rated-detailing-albuquerque.png')",
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col">
            <div className="text-center mb-auto pt-4 max-w-4xl mx-auto w-full">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white drop-shadow-2xl mb-5">
                Expert Mobile Auto Detailing in Albuquerque, NM | We Come to You
              </h1>
              <p className="text-xl md:text-2xl text-gray-200 mb-4 leading-relaxed drop-shadow-lg">
                Skip the shop and get professional <Link to="/service/mobile-auto-detailing" className="text-white underline hover:text-gray-200">mobile car detailing Albuquerque</Link> delivered to your driveway, office, or apartment. Our fully self-contained unit brings water, power, and commercial-grade products directly to you.
              </p>
